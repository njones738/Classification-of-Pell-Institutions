...
# Make sure you change your paths to your relevant paths
# %%
...
out_path = "C:/Code/GITHUB/csc/Classification-of-Pell-Institutions/data/created_subsets/"

idcsc = out_path + "id_csc.feather"
cipcsc = out_path + "cip_csc.feather"
geoloccsc = out_path + "geolocation_csc.feather"
instdemocsc = out_path + "inst_demographic_csc.feather"
studdemocsc = out_path + "stud_demographic_csc.feather"
pcipcsc = out_path + "pcip_csc.feather"
numcsc = out_path + "num_csc.feather"
...
#################################################################
# %%
id_csc.to_feather(out_path + "idcsc.feather")
target_variable.to_feather(out_path + "tarcsc.feather")
full_df.to_feather(out_path + "full_df.feather")
