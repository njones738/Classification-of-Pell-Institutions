...
# in-paths
fip_pth <- "data/state_fp_codes.csv"
csc_pth <- "data/MERGED2018_19_PP.csv"
csc_dict_pth <- "data/csc_dict.csv"
data_dict_pth <- "data/data_dict.csv"
data_def_pth <- "data/data_definitions.csv"
data_type_pth <- "data/full_df.csv"

# out-paths
idcsc <- "C:/Code/GITHUB/csc/Classification-of-Pell-Institutions/data/created_subsets/id_csc.feather" # nolint
cipcsc <- "C:/Code/GITHUB/csc/Classification-of-Pell-Institutions/data/created_subsets/cip_csc.feather" # nolint
geoloccsc <- "C:/Code/GITHUB/csc/Classification-of-Pell-Institutions/data/created_subsets/geolocation_csc.feather" # nolint
instdemocsc <- "C:/Code/GITHUB/csc/Classification-of-Pell-Institutions/data/created_subsets/inst_demographic_csc.feather" # nolint
studdemocsc <- "C:/Code/GITHUB/csc/Classification-of-Pell-Institutions/data/created_subsets/stud_demographic_csc.feather" # nolint
pcipcsc <- "C:/Code/GITHUB/csc/Classification-of-Pell-Institutions/data/created_subsets/pcip_csc.feather" # nolint
numcsc <- "C:/Code/GITHUB/csc/Classification-of-Pell-Institutions/data/created_subsets/num_csc.feather" # nolint
...
data_type <- read_csv(data_type_pth) #%>% rename(dev_cat = "dev-cat")
...
# view and write the missing information
# see_missing(idcsc) %>%
